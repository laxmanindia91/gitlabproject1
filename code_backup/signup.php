...
$sql = "insert into members (username , password , usertype , imagepath) values('$username' , '$password' , '$usertype' , '$image')";
...
if(!$result)
{
echo "<br>Error: Data not submitted due to error in parameters...";
}
else
{
